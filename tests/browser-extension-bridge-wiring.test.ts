...
describe('browser extension bridge wiring', () => {
  test('browser routes expose extension attach and pairing endpoints', () => {
    ...
    expect(routes).toContain("app.post('/browser/main-bridge/extension-switch'")
    expect(routes).toContain("app.post('/browser/main-bridge/extension-detach'")
  ...
  test('extension bridge posts current tab metadata and drives the tab through chrome.debugger', () => {
    ...
    expect(popup).toContain('/api/browser/main-bridge/extension-switch')
    expect(popup).toContain('/api/browser/main-bridge/extension-detach')
    ...
    expect(popup).toContain('bridgeSessionToken')
    ...
    expect(worker).toContain('bridgeSessionToken')
    ...
    expect(worker).toContain('message?.preserveSession')
  })
})
